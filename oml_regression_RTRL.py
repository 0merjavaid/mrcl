...
from model.meta_learner import RTRLMetaRegression
...
def main():
    ...
    my_experiment = experiment(args["name"], args, args["output_dir"], sql=False,
    ...
    logger.info("fully connected RTRL...")
    metalearner = RTRLMetaRegression(args, model_config, device=device).to(device)
